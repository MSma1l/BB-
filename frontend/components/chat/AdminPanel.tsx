          ...
          {active ? (
            <>
              ...
              >
                ...
                <span
                  className="flex h-10 w-10 items-center justify-center rounded-full font-display text-gold-300"
                  style={{
                    background: "linear-gradient(150deg,#3a1d0c,#1a0c12)",
                    border: "1px solid rgba(231,178,76,.3)",
                  }}
                ...
                <div>
                  <div className="text-[16px]" style={{ color: "#f0e2c5" }}>
                    {active.name}
                  </div>
                  <div className="text-[12px]" style={{ color: "#8fcf9a" }}>
                    {t.chat.online}
                  </div>
                </div>
              </div>
